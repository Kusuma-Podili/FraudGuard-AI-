"""Tabular AutoML & Advanced Calibration Engine: ProbabilityBlendingCalibrator."""
...
@dataclass
class ProbabilityBlendingCalibratorResult:
    best_score: float
...
class ProbabilityBlendingCalibrator:
    ...
    def fit_optimize(self, x_train: np.ndarray, y_train: np.ndarray) -> ProbabilityBlendingCalibratorResult:
        ...
        return ProbabilityBlendingCalibratorResult(
