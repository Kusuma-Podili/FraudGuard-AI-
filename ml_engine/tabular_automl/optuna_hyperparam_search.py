"""Tabular AutoML & Advanced Calibration Engine: OptunaHyperparameterOptimizer."""
...
@dataclass
class OptunaHyperparameterOptimizerResult:
    best_score: float
...
class OptunaHyperparameterOptimizer:
    ...
    def fit_optimize(self, x_train: np.ndarray, y_train: np.ndarray) -> OptunaHyperparameterOptimizerResult:
        ...
        return OptunaHyperparameterOptimizerResult(
