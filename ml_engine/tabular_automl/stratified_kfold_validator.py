"""Tabular AutoML & Advanced Calibration Engine: StratifiedKFoldCrossValidator."""
...
@dataclass
class StratifiedKFoldCrossValidatorResult:
    best_score: float
...
class StratifiedKFoldCrossValidator:
    ...
    def fit_optimize(self, x_train: np.ndarray, y_train: np.ndarray) -> StratifiedKFoldCrossValidatorResult:
        ...
        return StratifiedKFoldCrossValidatorResult(
