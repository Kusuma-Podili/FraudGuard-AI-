"""Tabular AutoML & Advanced Calibration Engine: CalibrationCurveBrierScorer."""
...
@dataclass
class CalibrationCurveBrierScorerResult:
    best_score: float
...
class CalibrationCurveBrierScorer:
    ...
    def fit_optimize(self, x_train: np.ndarray, y_train: np.ndarray) -> CalibrationCurveBrierScorerResult:
        ...
        return CalibrationCurveBrierScorerResult(
