"""Tabular AutoML & Advanced Calibration Engine: BayesianOptimizationTuner."""
...
@dataclass
class BayesianOptimizationTunerResult:
    best_score: float
...
class BayesianOptimizationTuner:
    ...
    def fit_optimize(self, x_train: np.ndarray, y_train: np.ndarray) -> BayesianOptimizationTunerResult:
        ...
        return BayesianOptimizationTunerResult(
