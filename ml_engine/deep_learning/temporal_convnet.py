"""Deep Neural Network Architecture: TemporalConvolutionalNetwork."""
...
@dataclass
class TemporalConvolutionalNetworkInferenceResult:
...
class TemporalConvolutionalNetwork:
    ...
    def forward(self, x: np.ndarray) -> TemporalConvolutionalNetworkInferenceResult:
        if len(x.shape) == 1:
            x = x.reshape(1, -1)
        ...
        return TemporalConvolutionalNetworkInferenceResult(
