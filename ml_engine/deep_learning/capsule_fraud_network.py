"""Deep Neural Network Architecture: CapsuleRoutingFraudClassifier."""
...
@dataclass
class CapsuleRoutingFraudClassifierInferenceResult:
...
class CapsuleRoutingFraudClassifier:
    ...
    def forward(self, x: np.ndarray) -> CapsuleRoutingFraudClassifierInferenceResult:
        if len(x.shape) == 1:
            x = x.reshape(1, -1)
        ...
        return CapsuleRoutingFraudClassifierInferenceResult(
