"""Deep Neural Network Architecture: ContrastiveSiameseSpendingNet."""
...
@dataclass
class ContrastiveSiameseSpendingNetInferenceResult:
...
class ContrastiveSiameseSpendingNet:
    ...
    def forward(self, x: np.ndarray) -> ContrastiveSiameseSpendingNetInferenceResult:
        if len(x.shape) == 1:
            x = x.reshape(1, -1)
        ...
        return ContrastiveSiameseSpendingNetInferenceResult(
