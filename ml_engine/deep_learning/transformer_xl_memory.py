"""Deep Neural Network Architecture: TransformerXLMemoryNetwork."""
...
@dataclass
class TransformerXLMemoryNetworkInferenceResult:
...
class TransformerXLMemoryNetwork:
    ...
    def forward(self, x: np.ndarray) -> TransformerXLMemoryNetworkInferenceResult:
        if len(x.shape) == 1:
            x = x.reshape(1, -1)
        ...
        return TransformerXLMemoryNetworkInferenceResult(
