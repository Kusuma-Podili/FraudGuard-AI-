"""Deep Neural Network Architecture: GraphSAGESubgraphSampler."""
...
@dataclass
class GraphSAGESubgraphSamplerInferenceResult:
...
class GraphSAGESubgraphSampler:
    ...
    def forward(self, x: np.ndarray) -> GraphSAGESubgraphSamplerInferenceResult:
        if len(x.shape) == 1:
            x = x.reshape(1, -1)
        ...
        return GraphSAGESubgraphSamplerInferenceResult(
