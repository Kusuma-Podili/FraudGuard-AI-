"""Deep Neural Network Architecture: SelfSupervisedMaskedTransactionLearner."""
...
@dataclass
class SelfSupervisedMaskedTransactionLearnerInferenceResult:
...
class SelfSupervisedMaskedTransactionLearner:
    ...
    def forward(self, x: np.ndarray) -> SelfSupervisedMaskedTransactionLearnerInferenceResult:
        if len(x.shape) == 1:
            x = x.reshape(1, -1)
        ...
        return SelfSupervisedMaskedTransactionLearnerInferenceResult(
