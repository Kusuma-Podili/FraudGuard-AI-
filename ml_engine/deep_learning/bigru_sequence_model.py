"""Deep Neural Network Architecture: BidirectionalGRUSequenceNet."""
...
@dataclass
class BidirectionalGRUSequenceNetInferenceResult:
...
class BidirectionalGRUSequenceNet:
    ...
    def forward(self, x: np.ndarray) -> BidirectionalGRUSequenceNetInferenceResult:
        if len(x.shape) == 1:
            x = x.reshape(1, -1)
        ...
        return BidirectionalGRUSequenceNetInferenceResult(
