"""Deep Neural Network Architecture: SparseMixtureOfExpertsEnsemble."""
...
@dataclass
class SparseMixtureOfExpertsEnsembleInferenceResult:
...
class SparseMixtureOfExpertsEnsemble:
    ...
    def forward(self, x: np.ndarray) -> SparseMixtureOfExpertsEnsembleInferenceResult:
        if len(x.shape) == 1:
            x = x.reshape(1, -1)
        ...
        return SparseMixtureOfExpertsEnsembleInferenceResult(
