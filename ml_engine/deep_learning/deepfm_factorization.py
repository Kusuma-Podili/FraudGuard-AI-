"""Deep Neural Network Architecture: DeepFMFraudClassifier."""
...
@dataclass
class DeepFMFraudClassifierInferenceResult:
...
class DeepFMFraudClassifier:
    ...
    def forward(self, x: np.ndarray) -> DeepFMFraudClassifierInferenceResult:
        if len(x.shape) == 1:
            x = x.reshape(1, -1)
        ...
        return DeepFMFraudClassifierInferenceResult(
