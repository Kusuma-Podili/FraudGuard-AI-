"""Deep Neural Network Architecture: RecurrentHighwayTransactionNet."""
...
@dataclass
class RecurrentHighwayTransactionNetInferenceResult:
...
class RecurrentHighwayTransactionNet:
    ...
    def forward(self, x: np.ndarray) -> RecurrentHighwayTransactionNetInferenceResult:
        if len(x.shape) == 1:
            x = x.reshape(1, -1)
        ...
        return RecurrentHighwayTransactionNetInferenceResult(
