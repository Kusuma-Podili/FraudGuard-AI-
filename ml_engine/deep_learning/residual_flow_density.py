"""Deep Neural Network Architecture: ResidualNormalizingFlowDensity."""
...
@dataclass
class ResidualNormalizingFlowDensityInferenceResult:
...
class ResidualNormalizingFlowDensity:
    ...
    def forward(self, x: np.ndarray) -> ResidualNormalizingFlowDensityInferenceResult:
        if len(x.shape) == 1:
            x = x.reshape(1, -1)
        ...
        return ResidualNormalizingFlowDensityInferenceResult(
