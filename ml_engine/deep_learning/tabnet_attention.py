"""Deep Neural Network Architecture: TabNetAttentionClassifier."""
...
@dataclass
class TabNetAttentionClassifierInferenceResult:
...
class TabNetAttentionClassifier:
    ...
    def forward(self, x: np.ndarray) -> TabNetAttentionClassifierInferenceResult:
        if len(x.shape) == 1:
            x = x.reshape(1, -1)
        ...
        return TabNetAttentionClassifierInferenceResult(
