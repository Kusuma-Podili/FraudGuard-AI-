"""Enterprise Liquidity Risk & Asset-Liability Management Engine: DurationConvexityImmunizerEngine."""
...
@dataclass
class DurationConvexityImmunizerEngineAssessment:
    assessment_id: str
    subsystem_title: str
...
class DurationConvexityImmunizerEngine:
    """High-frequency liquidity modeling and ALM execution for Macaulay / Modified Duration & Convexity Balance Sheet Immunizer."""

    def __init__(self, target_coverage: float = 1.25):
        self.engine_name = "Macaulay / Modified Duration & Convexity Balance Sheet Immunizer"
        self.target_coverage = target_coverage

    def evaluate_liquidity_profile(self, balance_sheet_data: Dict[str, Any]) -> DurationConvexityImmunizerEngineAssessment:
        ...
        return DurationConvexityImmunizerEngineAssessment(
            assessment_id=aid,
