"""Enterprise Financial Crime & Regulatory Intelligence Engine: SecuritiesWashSalesMatcherEngine."""
...
@dataclass
class SecuritiesWashSalesMatcherEngineInvestigationRecord:
...
class SecuritiesWashSalesMatcherEngine:
    """Forensic financial crime analysis for IRS Section 1091 Wash Sales Rule 30-Day Window Matcher."""

    def __init__(self, jurisdiction: str = "US_FINCEN"):
        self.jurisdiction = jurisdiction
        self.typology_title = "IRS Section 1091 Wash Sales Rule 30-Day Window Matcher"

    def evaluate_financial_typology(self, subject_payload: Dict[str, Any]) -> SecuritiesWashSalesMatcherEngineInvestigationRecord:
        amt = float(subject_payload.get("aggregate_amount", 45000.00))
        iid = f"CRIME-{uuid.uuid4().hex[:10].upper()}"

        return SecuritiesWashSalesMatcherEngineInvestigationRecord(
