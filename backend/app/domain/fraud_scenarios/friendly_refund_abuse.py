"""Forensic Fraud Scenario Detection Engine: FriendlyRefundAbuseDetector."""
...
@dataclass
class FriendlyRefundAbuseDetectorForensicReport:
    forensic_id: str
    scenario_title: str
...
class FriendlyRefundAbuseDetector:
    """Deep forensic pattern analyzer for First-Party Wardrobing & Double Refund Claim."""

    def __init__(self, sensitivity: float = 0.85):
        self.scenario_name = "First-Party Wardrobing & Double Refund Claim"
        self.sensitivity = sensitivity

    def analyze_event(self, transaction: Dict[str, Any], history: List[Dict[str, Any]]) -> FriendlyRefundAbuseDetectorForensicReport:
        ...
        return FriendlyRefundAbuseDetectorForensicReport(
            forensic_id=f_id,
