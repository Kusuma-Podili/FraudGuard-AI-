"""Forensic Fraud Scenario Detection Engine: InvoiceManipulationBecDetector."""
...
@dataclass
class InvoiceManipulationBecDetectorForensicReport:
    forensic_id: str
    scenario_title: str
...
class InvoiceManipulationBecDetector:
    """Deep forensic pattern analyzer for Business Email Compromise (BEC) & Account Divert."""

    def __init__(self, sensitivity: float = 0.85):
        self.scenario_name = "Business Email Compromise (BEC) & Account Divert"
        self.sensitivity = sensitivity

    def analyze_event(self, transaction: Dict[str, Any], history: List[Dict[str, Any]]) -> InvoiceManipulationBecDetectorForensicReport:
        ...
        return InvoiceManipulationBecDetectorForensicReport(
            forensic_id=f_id,
