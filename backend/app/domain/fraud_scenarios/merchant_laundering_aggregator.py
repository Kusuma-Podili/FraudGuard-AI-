"""Forensic Fraud Scenario Detection Engine: MerchantLaunderingAggregatorDetector."""
...
@dataclass
class MerchantLaunderingAggregatorDetectorForensicReport:
    forensic_id: str
    scenario_title: str
...
class MerchantLaunderingAggregatorDetector:
    """Deep forensic pattern analyzer for Unauthorized Transaction Aggregation & Laundering."""

    def __init__(self, sensitivity: float = 0.85):
        self.scenario_name = "Unauthorized Transaction Aggregation & Laundering"
        self.sensitivity = sensitivity

    def analyze_event(self, transaction: Dict[str, Any], history: List[Dict[str, Any]]) -> MerchantLaunderingAggregatorDetectorForensicReport:
        ...
        return MerchantLaunderingAggregatorDetectorForensicReport(
            forensic_id=f_id,
