"""Forensic Fraud Scenario Detection Engine: OtpBotInterceptionDetector."""
...
@dataclass
class OtpBotInterceptionDetectorForensicReport:
    forensic_id: str
    scenario_title: str
...
class OtpBotInterceptionDetector:
    """Deep forensic pattern analyzer for Voice OTP Bot & Automated Robocall Phishing."""

    def __init__(self, sensitivity: float = 0.85):
        self.scenario_name = "Voice OTP Bot & Automated Robocall Phishing"
        self.sensitivity = sensitivity

    def analyze_event(self, transaction: Dict[str, Any], history: List[Dict[str, Any]]) -> OtpBotInterceptionDetectorForensicReport:
        ...
        return OtpBotInterceptionDetectorForensicReport(
            forensic_id=f_id,
