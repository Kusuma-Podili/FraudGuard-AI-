"""Forensic Fraud Scenario Detection Engine: ContactlessRelayAttackDetector."""
...
@dataclass
class ContactlessRelayAttackDetectorForensicReport:
    forensic_id: str
    scenario_title: str
...
class ContactlessRelayAttackDetector:
    """Deep forensic pattern analyzer for NFC Contactless Distance Bounding & Relay Time Delay."""

    def __init__(self, sensitivity: float = 0.85):
        self.scenario_name = "NFC Contactless Distance Bounding & Relay Time Delay"
        self.sensitivity = sensitivity

    def analyze_event(self, transaction: Dict[str, Any], history: List[Dict[str, Any]]) -> ContactlessRelayAttackDetectorForensicReport:
        ...
        return ContactlessRelayAttackDetectorForensicReport(
            forensic_id=f_id,
