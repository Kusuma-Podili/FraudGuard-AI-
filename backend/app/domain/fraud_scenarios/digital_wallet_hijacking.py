"""Forensic Fraud Scenario Detection Engine: DigitalWalletHijackingDetector."""
...
@dataclass
class DigitalWalletHijackingDetectorForensicReport:
    forensic_id: str
    scenario_title: str
...
class DigitalWalletHijackingDetector:
    """Deep forensic pattern analyzer for Apple Pay Push-Provisioning Token Hijacking."""

    def __init__(self, sensitivity: float = 0.85):
        self.scenario_name = "Apple Pay Push-Provisioning Token Hijacking"
        self.sensitivity = sensitivity

    def analyze_event(self, transaction: Dict[str, Any], history: List[Dict[str, Any]]) -> DigitalWalletHijackingDetectorForensicReport:
        ...
        return DigitalWalletHijackingDetectorForensicReport(
            forensic_id=f_id,
