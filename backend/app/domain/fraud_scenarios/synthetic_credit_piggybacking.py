"""Forensic Fraud Scenario Detection Engine: SyntheticCreditPiggybackingDetector."""
...
@dataclass
class SyntheticCreditPiggybackingDetectorForensicReport:
    forensic_id: str
    scenario_title: str
...
class SyntheticCreditPiggybackingDetector:
    """Deep forensic pattern analyzer for Credit Piggybacking & Authorized User Seasoning."""

    def __init__(self, sensitivity: float = 0.85):
        self.scenario_name = "Credit Piggybacking & Authorized User Seasoning"
        self.sensitivity = sensitivity

    def analyze_event(self, transaction: Dict[str, Any], history: List[Dict[str, Any]]) -> SyntheticCreditPiggybackingDetectorForensicReport:
        ...
        return SyntheticCreditPiggybackingDetectorForensicReport(
            forensic_id=f_id,
