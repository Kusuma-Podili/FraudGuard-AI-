"""Forensic Fraud Scenario Detection Engine: MerchantIdentityTheftDetector."""
...
@dataclass
class MerchantIdentityTheftDetectorForensicReport:
    forensic_id: str
    scenario_title: str
...
class MerchantIdentityTheftDetector:
    """Deep forensic pattern analyzer for Synthetic Business Entity & Ghost Terminal Creation."""

    def __init__(self, sensitivity: float = 0.85):
        self.scenario_name = "Synthetic Business Entity & Ghost Terminal Creation"
        self.sensitivity = sensitivity

    def analyze_event(self, transaction: Dict[str, Any], history: List[Dict[str, Any]]) -> MerchantIdentityTheftDetectorForensicReport:
        ...
        return MerchantIdentityTheftDetectorForensicReport(
            forensic_id=f_id,
