"""Forensic Fraud Scenario Detection Engine: BustOutFraudDetector."""
...
@dataclass
class BustOutFraudDetectorForensicReport:
    forensic_id: str
    scenario_title: str
...
class BustOutFraudDetector:
    """Deep forensic pattern analyzer for Credit Card Bust-Out & Sudden Credit Limit Max-Out."""

    def __init__(self, sensitivity: float = 0.85):
        self.scenario_name = "Credit Card Bust-Out & Sudden Credit Limit Max-Out"
        self.sensitivity = sensitivity

    def analyze_event(self, transaction: Dict[str, Any], history: List[Dict[str, Any]]) -> BustOutFraudDetectorForensicReport:
        ...
        return BustOutFraudDetectorForensicReport(
            forensic_id=f_id,
