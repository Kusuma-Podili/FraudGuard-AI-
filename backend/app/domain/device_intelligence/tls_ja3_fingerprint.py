"""Hardware & Execution Environment Sensor: TlsJa3Fingerprint."""
...
@dataclass
class TlsJa3FingerprintTelemetryResult:
    entropy_bits: float
    signature_hash: str
    is_spoofed: bool
...
class TlsJa3FingerprintSensor:
    """Anti-spoofing sensor analysis for tls_ja3_fingerprint."""

    def __init__(self, salt: str = "sensor_salt_2026"):
        self.salt = salt
        self.sensor_name = "TlsJa3Fingerprint"

    def analyze_telemetry(self, raw_telemetry: Dict[str, Any]) -> TlsJa3FingerprintTelemetryResult:
        anomalies = []
        ...
        return TlsJa3FingerprintTelemetryResult(
