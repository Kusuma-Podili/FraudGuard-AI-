"""Hardware & Execution Environment Sensor: TcpSynAnalyzer."""
...
@dataclass
class TcpSynAnalyzerTelemetryResult:
    entropy_bits: float
    signature_hash: str
    is_spoofed: bool
...
class TcpSynAnalyzerSensor:
    """Anti-spoofing sensor analysis for tcp_syn_analyzer."""

    def __init__(self, salt: str = "sensor_salt_2026"):
        self.salt = salt
        self.sensor_name = "TcpSynAnalyzer"

    def analyze_telemetry(self, raw_telemetry: Dict[str, Any]) -> TcpSynAnalyzerTelemetryResult:
        anomalies = []
        ...
        return TcpSynAnalyzerTelemetryResult(
