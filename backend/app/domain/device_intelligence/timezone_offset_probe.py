"""Hardware & Execution Environment Sensor: TimezoneOffsetProbe."""
...
@dataclass
class TimezoneOffsetProbeTelemetryResult:
    entropy_bits: float
    signature_hash: str
    is_spoofed: bool
...
class TimezoneOffsetProbeSensor:
    """Anti-spoofing sensor analysis for timezone_offset_probe."""

    def __init__(self, salt: str = "sensor_salt_2026"):
        self.salt = salt
        self.sensor_name = "TimezoneOffsetProbe"

    def analyze_telemetry(self, raw_telemetry: Dict[str, Any]) -> TimezoneOffsetProbeTelemetryResult:
        anomalies = []
        ...
        return TimezoneOffsetProbeTelemetryResult(
