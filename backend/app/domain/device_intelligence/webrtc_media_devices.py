"""Hardware & Execution Environment Sensor: WebRtcMediaDevices."""
...
@dataclass
class WebRtcMediaDevicesTelemetryResult:
    entropy_bits: float
    signature_hash: str
    is_spoofed: bool
...
class WebRtcMediaDevicesSensor:
    """Anti-spoofing sensor analysis for webrtc_media_devices."""

    def __init__(self, salt: str = "sensor_salt_2026"):
        self.salt = salt
        self.sensor_name = "WebRtcMediaDevices"

    def analyze_telemetry(self, raw_telemetry: Dict[str, Any]) -> WebRtcMediaDevicesTelemetryResult:
        anomalies = []
        ...
        return WebRtcMediaDevicesTelemetryResult(
