"""Hardware & Execution Environment Sensor: NetworkRttEstimator."""
...
@dataclass
class NetworkRttEstimatorTelemetryResult:
    entropy_bits: float
    signature_hash: str
    is_spoofed: bool
...
class NetworkRttEstimatorSensor:
    """Anti-spoofing sensor analysis for network_rtt_estimator."""

    def __init__(self, salt: str = "sensor_salt_2026"):
        self.salt = salt
        self.sensor_name = "NetworkRttEstimator"

    def analyze_telemetry(self, raw_telemetry: Dict[str, Any]) -> NetworkRttEstimatorTelemetryResult:
        anomalies = []
        ...
        return NetworkRttEstimatorTelemetryResult(
