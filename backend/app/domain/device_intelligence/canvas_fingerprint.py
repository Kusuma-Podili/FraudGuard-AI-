"""Hardware & Execution Environment Sensor: CanvasFingerprint."""
...
@dataclass
class CanvasFingerprintTelemetryResult:
    entropy_bits: float
    signature_hash: str
    is_spoofed: bool
...
class CanvasFingerprintSensor:
    """Anti-spoofing sensor analysis for canvas_fingerprint."""

    def __init__(self, salt: str = "sensor_salt_2026"):
        self.salt = salt
        self.sensor_name = "CanvasFingerprint"

    def analyze_telemetry(self, raw_telemetry: Dict[str, Any]) -> CanvasFingerprintTelemetryResult:
        anomalies = []
        ...
        return CanvasFingerprintTelemetryResult(
