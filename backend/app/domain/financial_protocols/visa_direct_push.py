"""Enterprise Banking & Payment Protocol Engine: VisaDirectPushToCardGateway."""
...
@dataclass
class VisaDirectPushToCardGatewayMessage:
    message_id: str
    protocol_type: str
    sender_bic: str
    receiver_bic: str
...
class VisaDirectPushToCardGateway:
    """High-throughput parser, validator, and packager for Visa Direct Real-Time Push-to-Card & Fast Funds Payout."""

    def __init__(self, institution_bic: str = "FRDGUS33XXX"):
        self.protocol_name = "Visa Direct Real-Time Push-to-Card & Fast Funds Payout"
        self.institution_bic = institution_bic

    def parse_and_validate(self, raw_payload: str) -> VisaDirectPushToCardGatewayMessage:
        ...
        return VisaDirectPushToCardGatewayMessage(
            message_id=msg_id,
            protocol_type="VisaDirectPushToCardGateway",
    ...
    def verify_iso_compliance(self, msg: VisaDirectPushToCardGatewayMessage) -> Tuple[bool, List[str]]:
        errors = []
