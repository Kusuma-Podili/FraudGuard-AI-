"""Enterprise Banking & Payment Protocol Engine: SepaCreditTransferEngine."""
...
@dataclass
class SepaCreditTransferEngineMessage:
    message_id: str
    protocol_type: str
    sender_bic: str
    receiver_bic: str
...
class SepaCreditTransferEngine:
    """High-throughput parser, validator, and packager for Single Euro Payments Area (SEPA) Instant Credit Transfer."""

    def __init__(self, institution_bic: str = "FRDGUS33XXX"):
        self.protocol_name = "Single Euro Payments Area (SEPA) Instant Credit Transfer"
        self.institution_bic = institution_bic

    def parse_and_validate(self, raw_payload: str) -> SepaCreditTransferEngineMessage:
        ...
        return SepaCreditTransferEngineMessage(
            message_id=msg_id,
            protocol_type="SepaCreditTransferEngine",
    ...
    def verify_iso_compliance(self, msg: SepaCreditTransferEngineMessage) -> Tuple[bool, List[str]]:
        errors = []
