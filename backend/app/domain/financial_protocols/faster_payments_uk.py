"""Enterprise Banking & Payment Protocol Engine: FasterPaymentsUkGateway."""
...
@dataclass
class FasterPaymentsUkGatewayMessage:
    message_id: str
    protocol_type: str
    sender_bic: str
    receiver_bic: str
...
class FasterPaymentsUkGateway:
    """High-throughput parser, validator, and packager for UK Faster Payments Service (FPS) Sub-Second Clearing."""

    def __init__(self, institution_bic: str = "FRDGUS33XXX"):
        self.protocol_name = "UK Faster Payments Service (FPS) Sub-Second Clearing"
        self.institution_bic = institution_bic

    def parse_and_validate(self, raw_payload: str) -> FasterPaymentsUkGatewayMessage:
        ...
        return FasterPaymentsUkGatewayMessage(
            message_id=msg_id,
            protocol_type="FasterPaymentsUkGateway",
    ...
    def verify_iso_compliance(self, msg: FasterPaymentsUkGatewayMessage) -> Tuple[bool, List[str]]:
        errors = []
