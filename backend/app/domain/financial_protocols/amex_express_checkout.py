"""Enterprise Banking & Payment Protocol Engine: AmexExpressCheckoutProtocol."""
...
@dataclass
class AmexExpressCheckoutProtocolMessage:
    message_id: str
    protocol_type: str
    sender_bic: str
    receiver_bic: str
...
class AmexExpressCheckoutProtocol:
    """High-throughput parser, validator, and packager for American Express Express Checkout & Tokenization Gateway."""

    def __init__(self, institution_bic: str = "FRDGUS33XXX"):
        self.protocol_name = "American Express Express Checkout & Tokenization Gateway"
        self.institution_bic = institution_bic

    def parse_and_validate(self, raw_payload: str) -> AmexExpressCheckoutProtocolMessage:
        ...
        return AmexExpressCheckoutProtocolMessage(
            message_id=msg_id,
            protocol_type="AmexExpressCheckoutProtocol",
    ...
    def verify_iso_compliance(self, msg: AmexExpressCheckoutProtocolMessage) -> Tuple[bool, List[str]]:
        errors = []
