"""Enterprise Banking & Payment Protocol Engine: MastercardSendPayoutEngine."""
...
@dataclass
class MastercardSendPayoutEngineMessage:
    message_id: str
    protocol_type: str
    sender_bic: str
    receiver_bic: str
...
class MastercardSendPayoutEngine:
    """High-throughput parser, validator, and packager for Mastercard Send Real-Time Global Disbursement Rail."""

    def __init__(self, institution_bic: str = "FRDGUS33XXX"):
        self.protocol_name = "Mastercard Send Real-Time Global Disbursement Rail"
        self.institution_bic = institution_bic

    def parse_and_validate(self, raw_payload: str) -> MastercardSendPayoutEngineMessage:
        ...
        return MastercardSendPayoutEngineMessage(
            message_id=msg_id,
            protocol_type="MastercardSendPayoutEngine",
    ...
    def verify_iso_compliance(self, msg: MastercardSendPayoutEngineMessage) -> Tuple[bool, List[str]]:
        errors = []
