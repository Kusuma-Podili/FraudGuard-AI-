"""Enterprise Banking & Payment Protocol Engine: BacsDirectDebitProtocol."""
...
@dataclass
class BacsDirectDebitProtocolMessage:
    message_id: str
    protocol_type: str
    sender_bic: str
    receiver_bic: str
...
class BacsDirectDebitProtocol:
    """High-throughput parser, validator, and packager for BACS UK Automated Clearing System & Direct Debit Processor."""

    def __init__(self, institution_bic: str = "FRDGUS33XXX"):
        self.protocol_name = "BACS UK Automated Clearing System & Direct Debit Processor"
        self.institution_bic = institution_bic

    def parse_and_validate(self, raw_payload: str) -> BacsDirectDebitProtocolMessage:
        ...
        return BacsDirectDebitProtocolMessage(
            message_id=msg_id,
            protocol_type="BacsDirectDebitProtocol",
    ...
    def verify_iso_compliance(self, msg: BacsDirectDebitProtocolMessage) -> Tuple[bool, List[str]]:
        errors = []
