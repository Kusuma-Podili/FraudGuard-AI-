"""Enterprise Counterparty Credit Risk & XVA Pricing Engine: PrimeBrokerageMarginLoanEngine."""
...
@dataclass
class PrimeBrokerageMarginLoanEngineOutput:
    calculation_id: str
    netting_set_id: str
...
class PrimeBrokerageMarginLoanEngine:
    """Production quantitative risk modeling for Hedge Fund Portfolio Margin & Cross-Product Multi-Asset Haircut."""

    def __init__(self, confidence_percentile: float = 0.95):
        self.risk_model_title = "Hedge Fund Portfolio Margin & Cross-Product Multi-Asset Haircut"
        self.confidence_percentile = confidence_percentile

    def compute_counterparty_risk(self, portfolio_trades: List[Dict[str, Any]]) -> PrimeBrokerageMarginLoanEngineOutput:
        ...
        return PrimeBrokerageMarginLoanEngineOutput(
            calculation_id=cid,
