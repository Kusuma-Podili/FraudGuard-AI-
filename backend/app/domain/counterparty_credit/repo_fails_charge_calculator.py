"""Enterprise Counterparty Credit Risk & XVA Pricing Engine: RepoFailsChargeCalculatorEngine."""
...
@dataclass
class RepoFailsChargeCalculatorEngineOutput:
    calculation_id: str
    netting_set_id: str
...
class RepoFailsChargeCalculatorEngine:
    """Production quantitative risk modeling for TMPG Fails Charge on Treasury and Agency Debt Transactions."""

    def __init__(self, confidence_percentile: float = 0.95):
        self.risk_model_title = "TMPG Fails Charge on Treasury and Agency Debt Transactions"
        self.confidence_percentile = confidence_percentile

    def compute_counterparty_risk(self, portfolio_trades: List[Dict[str, Any]]) -> RepoFailsChargeCalculatorEngineOutput:
        ...
        return RepoFailsChargeCalculatorEngineOutput(
            calculation_id=cid,
