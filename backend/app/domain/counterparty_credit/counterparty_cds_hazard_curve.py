"""Enterprise Counterparty Credit Risk & XVA Pricing Engine: CounterpartyCdsHazardCurveEngine."""
...
@dataclass
class CounterpartyCdsHazardCurveEngineOutput:
    calculation_id: str
    netting_set_id: str
...
class CounterpartyCdsHazardCurveEngine:
    """Production quantitative risk modeling for Counterparty CDS Par Spread to Cumulative Default Hazard Curve."""

    def __init__(self, confidence_percentile: float = 0.95):
        self.risk_model_title = "Counterparty CDS Par Spread to Cumulative Default Hazard Curve"
        self.confidence_percentile = confidence_percentile

    def compute_counterparty_risk(self, portfolio_trades: List[Dict[str, Any]]) -> CounterpartyCdsHazardCurveEngineOutput:
        ...
        return CounterpartyCdsHazardCurveEngineOutput(
            calculation_id=cid,
