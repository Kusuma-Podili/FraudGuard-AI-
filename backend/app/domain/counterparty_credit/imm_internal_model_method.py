"""Enterprise Counterparty Credit Risk & XVA Pricing Engine: ImmInternalModelMethodEngine."""
...
@dataclass
class ImmInternalModelMethodEngineOutput:
    calculation_id: str
    netting_set_id: str
...
class ImmInternalModelMethodEngine:
    """Production quantitative risk modeling for Internal Model Method (IMM) Alpha Multiplier & Effective EPE."""

    def __init__(self, confidence_percentile: float = 0.95):
        self.risk_model_title = "Internal Model Method (IMM) Alpha Multiplier & Effective EPE"
        self.confidence_percentile = confidence_percentile

    def compute_counterparty_risk(self, portfolio_trades: List[Dict[str, Any]]) -> ImmInternalModelMethodEngineOutput:
        ...
        return ImmInternalModelMethodEngineOutput(
            calculation_id=cid,
