"""Enterprise Counterparty Credit Risk & XVA Pricing Engine: SovereignCrossBorderCapEngine."""
...
@dataclass
class SovereignCrossBorderCapEngineOutput:
    calculation_id: str
    netting_set_id: str
...
class SovereignCrossBorderCapEngine:
    """Production quantitative risk modeling for Country Transfer & Convertibility Risk Rating Cap Enforcer."""

    def __init__(self, confidence_percentile: float = 0.95):
        self.risk_model_title = "Country Transfer & Convertibility Risk Rating Cap Enforcer"
        self.confidence_percentile = confidence_percentile

    def compute_counterparty_risk(self, portfolio_trades: List[Dict[str, Any]]) -> SovereignCrossBorderCapEngineOutput:
        ...
        return SovereignCrossBorderCapEngineOutput(
            calculation_id=cid,
