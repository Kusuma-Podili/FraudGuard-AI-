"""Enterprise Counterparty Credit Risk & XVA Pricing Engine: RehypothecatedCollateralCsaEngine."""
...
@dataclass
class RehypothecatedCollateralCsaEngineOutput:
    calculation_id: str
    netting_set_id: str
...
class RehypothecatedCollateralCsaEngine:
    """Production quantitative risk modeling for Eligible Collateral Valuation Haircuts under 2016 VM CSA."""

    def __init__(self, confidence_percentile: float = 0.95):
        self.risk_model_title = "Eligible Collateral Valuation Haircuts under 2016 VM CSA"
        self.confidence_percentile = confidence_percentile

    def compute_counterparty_risk(self, portfolio_trades: List[Dict[str, Any]]) -> RehypothecatedCollateralCsaEngineOutput:
        ...
        return RehypothecatedCollateralCsaEngineOutput(
            calculation_id=cid,
