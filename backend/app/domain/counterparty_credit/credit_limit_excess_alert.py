"""Enterprise Counterparty Credit Risk & XVA Pricing Engine: CreditLimitExcessAlertEngine."""
...
@dataclass
class CreditLimitExcessAlertEngineOutput:
    calculation_id: str
    netting_set_id: str
...
class CreditLimitExcessAlertEngine:
    """Production quantitative risk modeling for Real-Time Counterparty Credit Limit & Settlement Cap Sentry."""

    def __init__(self, confidence_percentile: float = 0.95):
        self.risk_model_title = "Real-Time Counterparty Credit Limit & Settlement Cap Sentry"
        self.confidence_percentile = confidence_percentile

    def compute_counterparty_risk(self, portfolio_trades: List[Dict[str, Any]]) -> CreditLimitExcessAlertEngineOutput:
        ...
        return CreditLimitExcessAlertEngineOutput(
            calculation_id=cid,
