// Enterprise Next.js 14 / React 18 Console Component: DepositRunoffBehaviorView
// Title: Non-Maturity Deposit (NMD) Behavioral Beta View
...
export interface DepositRunoffBehaviorViewProps {
  portfolioId?: string;
  onSimulationComplete?: (result: any) => void;
}

export const DepositRunoffBehaviorView: React.FC<DepositRunoffBehaviorViewProps> = ({ portfolioId = 'PORTFOLIO_LIQ_01', onSimulationComplete }) => {
    ...
    <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 text-gray-100 shadow-2xl space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-800 pb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base font-bold text-gray-100">Non-Maturity Deposit (NMD) Behavioral Beta View</h3>
      ...
      <div className="p-4 bg-gray-950 border border-gray-800 rounded-xl space-y-2">
        ...
        <p className="text-xs text-gray-400 leading-relaxed">
          The Non-Maturity Deposit (NMD) Behavioral Beta View executes quantitative capital simulation, dynamic balance sheet stress testing,
...
export default DepositRunoffBehaviorView;
