// Enterprise Next.js 14 / React 18 Console Component: FxClsLiquidityRadar
// Title: Continuous Linked Settlement (CLS) FX Liquidity Radar
...
export interface FxClsLiquidityRadarProps {
  deskId?: string;
  onReconciliationComplete?: (result: any) => void;
}

export const FxClsLiquidityRadar: React.FC<FxClsLiquidityRadarProps> = ({ deskId = 'DESK_GLOBAL_01', onReconciliationComplete }) => {
    ...
    <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 text-gray-100 shadow-2xl space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-800 pb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base font-bold text-gray-100">Continuous Linked Settlement (CLS) FX Liquidity Radar</h3>
      ...
      <div className="p-4 bg-gray-950 border border-gray-800 rounded-xl space-y-2">
        ...
        <p className="text-xs text-gray-400 leading-relaxed">
          The Continuous Linked Settlement (CLS) FX Liquidity Radar executes real-time transaction netting, straight-through clearing, and automated regulatory reporting
...
export default FxClsLiquidityRadar;
