...
export interface SyntheticProbeNeutralizingEngineProps {
  policyId?: string;
  onPolicyUpdate?: (result: any) => void;
}

export const SyntheticProbeNeutralizingEngine: React.FC<SyntheticProbeNeutralizingEngineProps> = ({ policyId = 'POL_ACTIVE_001', onPolicyUpdate }) => {
...
export default SyntheticProbeNeutralizingEngine;
